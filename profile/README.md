...
| [Open Science Discovery Engines: Empowering Librarian Use Through a Case Study Exploration of the NASA Science Explorer](http://ucla-imls-open-sci.info/lc-scix-open-science/) | Katie Frey <br/> Jennifer Lynn Bartlett <br/> Stephanie Jarmak | pre-Alpha | [Link]([http://ucla-imls-open-sci.info/lc-scix-open-science/](https://github.com/ucla-imls-open-sci/lc-scix-open-science)) |
